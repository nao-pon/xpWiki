...
$root->facemark_rules = array(
	// Face marks
	'\s(\:\))(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/smile.png" />',
	'\s(\:D)(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/bigsmile.png" />',
	'\s(\:p)(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/huh.png" />',
	'\s(\:d)(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/huh.png" />',
	'\s(XD)(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/oh.png" />',
	'\s(X\()(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/oh.png" />',
	'\s(;\))(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/wink.png" />',
	'\s(;\()(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/sad.png" />',
	'\s(\:\()(?!\w)'	=> ' <img alt="$1" src="' . $const['IMAGE_DIR'] . 'face/sad.png" />',
