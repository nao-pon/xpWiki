...
var FCKBrowserInfo = {
    IsIE: /*@cc_on!@*/ false,
    IsIE10: /*@cc_on!@*/ false && (parseInt(s.match(/msie (\d+)/)[1], 10) >= 10),
...
var FCKDomTools = {
    ...
    SetOpacity: function (A, B) {
        if (FCKBrowserInfo.IsIE && !FCKBrowserInfo.IsIE10) {
            B = Math.round(B * 100);
...
FCKXHtml.GetXHTML = function (A, B, C) {
    ...
    else this._AppendChildNodes(this.MainNode, A, false); if (FCKBrowserInfo.IsIE) FCKXHtml._RemoveXHtmlJobProperties(A);
...
var FCKElementPath = function (A) {
    ...
    while (e) {
        if (e.nodeType == 1) {
            ...
            if (FCKBrowserInfo.IsIE && e.scopeName && e.scopeName != 'HTML') E = e.scopeName.toLowerCase() + ':' + E;
            if (!C) {
...
FCKDomRange.prototype._GetSelectionMarkerTag = function (A) {
    ...
    if (D.parentElement().document && D.parentElement().document != B) return null;
    D.collapse(A === true);
    ...
    Execute: function () {
        ...
        if (A == 0) {
            ...
            while (O.length > 0) {
                ...
                else FCKDomTools.BreakParent(W, W.parentNode, B); if (!N._fckbqprocessed) {
                    T.push(N);
