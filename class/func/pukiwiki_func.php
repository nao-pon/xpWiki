...
// $Id: pukiwiki_func.php,v 1.14 2006/10/30 13:59:31 nao-pon Exp $
//
...
//----- Start file.php -----//
	...
	function file_write($dir, $page, $str, $notimestamp = FALSE)
	{
		...
		} else if ($dir == $this->cont['DIFF_DIR'] && $this->root->notify) {
...
//----- Start func.php -----//
	...
	function do_search($word, $type = 'AND', $non_format = FALSE, $base = '')
	{
		...
		foreach (array_keys($pages) as $page) {
			...
			$retval .= ' <li><a href="' . $this->root->script . '?cmd=read&amp;page=' .
...
//----- Start trackback.php -----//
	...
	function tb_send($page, $plus, $minus = '')
	{
		...
		$putdata = array(
			...
			'blog_name' => $this->root->page_title . ' (' . $this->cont['PLUGIN_TRACKBACK_VERSION'] . ')',
...
EOD;
		// reformat
		$this->root->head_tags = array();
		$this->root->head_pre_tags = array();
