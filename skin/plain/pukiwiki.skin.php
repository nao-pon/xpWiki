...
// $Id: pukiwiki.skin.php,v 1.1 2008/04/29 11:41:32 nao-pon Exp $
// Copyright (C)
...
$favicon
$head_pre_tag
<link rel="stylesheet" type="text/css" media="all" href="{$this->cont['LOADER_URL']}?skin={$this->cont['SKIN_NAME']}&amp;charset={$css_charset}&amp;pw={$this->root->pre_width}&amp;swap&amp;src=main.css" charset="{$css_charset}" />
