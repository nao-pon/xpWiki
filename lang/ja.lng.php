...
// $Id: ja.lng.php,v 1.5 2006/11/29 13:09:47 nao-pon Exp $
// Copyright (C)
...
///////////////////////////////////////
// popular.inc.php
$root->_popular_plugin_frame       = '<h5>人気の%d件</h5><div>%s</div>';
$root->_popular_plugin_today_frame = '<h5>今日の%d件</h5><div>%s</div>';
