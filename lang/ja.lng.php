...
///////////////////////////////////////
// popular.inc.php
$root->_popular_plugin_frame       = '<h5>人気の%1$d件%3$s</h5><div>%2$s</div>';
$root->_popular_plugin_today_frame = '<h5>今日の%1$d件%3$s</h5><div>%2$s</div>';
$root->_popular_plugin_yesterday_frame = '<h5>昨日の%1$d件%3$s</h5><div>%2$s</div>';
